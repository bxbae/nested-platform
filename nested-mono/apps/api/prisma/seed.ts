...
async function main() {
  ...
  const rooms = [
    ...
    {
      name: "연남 고요한 집",
      legacyName: "Yeonnam Quiet House",
      region: "연남동",
      lat: 37.5636,
      lng: 126.9256,
      monthlyRent: 690000,
    ...
    {
      name: "망원 리버 스튜디오",
      legacyName: "Mangwon River Studios",
      region: "망원동",
      lat: 37.5556,
      lng: 126.9018,
      monthlyRent: 720000,
    ...
    {
      name: "판교 밸리 하우스",
      legacyName: "Pangyo Valley House",
      region: "판교",
      lat: 37.3948,
      lng: 127.1112,
      monthlyRent: 850000,
    ...
    {
      name: "홍대 메이커 하우스",
      legacyName: "Hongdae Maker House",
      region: "서교동",
      lat: 37.5561,
      lng: 126.9236,
      monthlyRent: 470000,
    ...
    {
      name: "서초 출퇴근 하우스",
      legacyName: "Seocho Commuter House",
      region: "서초동",
      lat: 37.4837,
      lng: 127.0324,
      monthlyRent: 830000,
    ...
    await prisma.room.create({
      data: {
        ...
        sharedFacilities:
          r.rentalUnit === "WHOLE"
            ? []
            : ["BATHROOM", "KITCHEN", "LIVING_ROOM", "LAUNDRY_ROOM"],
