...
const ROOM_AMENITIES: Record<string, string[]> = {
  "성수 로움": ["wifi", "laundry", "kitchen", "rooftop", "desk", "aircon"],
  "연남 고요한 집": ["wifi", "laundry", "kitchen", "desk", "aircon", "parking"],
  "망원 리버 스튜디오": ["wifi", "kitchen", "laundry", "aircon", "desk"],
  "판교 밸리 하우스": ["wifi", "parking", "kitchen", "desk", "aircon", "laundry"],
  "뚝섬 선라이즈": ["wifi", "rooftop", "kitchen", "aircon", "laundry"],
  "홍대 메이커 하우스": ["wifi", "desk", "kitchen", "rooftop", "aircon"],
  "서초 출퇴근 하우스": ["wifi", "parking", "laundry", "kitchen", "desk", "aircon"],
  "강남 로프트 22": ["wifi", "parking", "rooftop", "kitchen", "desk", "aircon", "laundry"],
};
...
async function main() {
  ...
  const rooms = [
    { name: "성수 로움", legacyName: "Seongsu Loom", region: "성수동", lat: 37.5446, lng: 127.0559, monthlyRent: 780000 },
    { name: "연남 고요한 집", legacyName: "Yeonnam Quiet House", region: "연남동", lat: 37.5636, lng: 126.9256, monthlyRent: 690000 },
    { name: "망원 리버 스튜디오", legacyName: "Mangwon River Studios", region: "망원동", lat: 37.5556, lng: 126.9018, monthlyRent: 720000 },
    { name: "판교 밸리 하우스", legacyName: "Pangyo Valley House", region: "판교", lat: 37.3948, lng: 127.1112, monthlyRent: 850000 },
    { name: "뚝섬 선라이즈", legacyName: "Ttukseom Sunrise", region: "성수동", lat: 37.5470, lng: 127.0660, monthlyRent: 810000 },
    { name: "홍대 메이커 하우스", legacyName: "Hongdae Maker House", region: "서교동", lat: 37.5561, lng: 126.9236, monthlyRent: 700000 },
    { name: "서초 출퇴근 하우스", legacyName: "Seocho Commuter House", region: "서초동", lat: 37.4837, lng: 127.0324, monthlyRent: 830000 },
    { name: "강남 로프트 22", legacyName: "Gangnam Loft 22", region: "역삼동", lat: 37.5006, lng: 127.0364, monthlyRent: 920000 },
  ];
  ...
  for (const r of rooms) {
    ...
    const existing = await prisma.room.findMany({
      where: { name: { in: [r.name, r.legacyName] } },
      select: { id: true },
    });
